...
@section('content')
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold mt-2">Create Page</h1>
    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="hero_highlight" value="{{ old('hero_highlight') }}"
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 outline-none"
                        ...
                        <div>
                            ...
                            <textarea name="subtitle" rows="2"
                                ...
                                placeholder="Page subtitle or description">{{ old('subtitle') }}</textarea>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <textarea name="content" id="content" rows="15"
                        class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 outline-none"
                        placeholder="Page content (HTML supported for static pages like Privacy Policy)">{{ old('content') }}</textarea>
                </div>
            </div>
