...
@section('description', 'Get in touch with IGReelDownloader.net. We are here to help with any questions, feedback, or support requests.')
...
<section class="relative py-12 sm:py-16 hero-gradient overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 dark:text-white mb-4 slide-up" style="animation-delay: 0.1s">
            Contact Us
        </h1>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <div class="flex items-start space-x-4 mb-6">
                        ...
                        <div>
                            ...
                            <a href="mailto:support@igreeldownloader.net" class="text-violet-600 dark:text-violet-400 hover:underline text-sm">support@igreeldownloader.net</a>
                    ...
                    <!-- DMCA -->
                    <div class="flex items-start space-x-4 mb-6">
                        <div class="w-12 h-12 rounded-xl bg-pink-100 dark:bg-pink-900/30 flex items-center justify-center flex-shrink-0">
                        ...
                        <div>
                            ...
                            <a href="mailto:dmca@igreeldownloader.net" class="text-violet-600 dark:text-violet-400 hover:underline text-sm">dmca@igreeldownloader.net</a>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:privacy@igreeldownloader.net" class="text-violet-600 dark:text-violet-400 hover:underline text-sm">privacy@igreeldownloader.net</a>
                ...
                <!-- FAQ Link -->
                <div class="bg-gradient-to-br from-violet-500/10 to-pink-500/10 rounded-2xl border border-violet-200 dark:border-violet-800 p-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <a href="{{ route('instagram.reels') }}#faq" class="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                            Reels FAQ
                        </a>
                        <a href="{{ route('instagram.video') }}#faq" class="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                            Video FAQ
                        </a>
                        <a href="{{ route('instagram.photo') }}#faq" class="px-3 py-1.5 bg-white dark:bg-gray-800 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                            Photo FAQ
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs font-medium rounded-full">24-48 hours</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-gray-600 dark:text-gray-400 text-sm">Technical Support</span>
                            <span class="px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-xs font-medium rounded-full">1-3 days</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-gray-600 dark:text-gray-400 text-sm">DMCA Requests</span>
                            <span class="px-2 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400 text-xs font-medium rounded-full">3-5 days</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800 p-6 sm:p-8">
                    ...
                    <form id="contactForm" class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-500">If reporting an issue with a specific Instagram URL, paste it here.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-500">Please provide as much detail as possible so we can help you better.</p>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <label for="consent" class="text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <a href="{{ route('privacy-policy') }}" class="text-violet-600 dark:text-violet-400 hover:underline">Privacy Policy</a> 
                    ...
                    <!-- Success Message -->
                    <div id="successMessage" class="hidden mt-6 p-6 rounded-2xl bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h4 class="font-semibold text-green-800 dark:text-green-200 text-lg">Message Sent Successfully!</h4>
                                <p class="text-green-700 dark:text-green-300 text-sm mt-1">Thank you for contacting us. We'll get back to you within 24-48 hours.</p>
                            </div>
                        </div>
                    </div>

                    <!-- Error Message -->
                    <div id="errorMessage" class="hidden mt-6 p-6 rounded-2xl bg-red-100 dark:bg-red-900/30 border border-red-200 dark:border-red-800">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h4 class="font-semibold text-red-800 dark:text-red-200 text-lg">Something went wrong</h4>
                                <p id="errorText" class="text-red-700 dark:text-red-300 text-sm mt-1">Please try again or email us directly.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                    Make sure the Instagram content is from a <strong>public account</strong>. Private content cannot be downloaded. Also, verify the URL is correct.
                </p>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                    Download speed depends on your internet connection and Instagram's servers. If it's too slow, try again later when there's less traffic.
                </p>
            </div>

            <!-- Issue 3 -->
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                <div class="w-12 h-12 rounded-xl bg-yellow-100 dark:bg-yellow-900/30 flex items-center justify-center mb-4">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                    We can only download content from <strong>public profiles</strong>. Ask the account owner to make their account public, or request permission directly.
                </p>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                    Make sure you're using the correct Instagram URL format. Copy the link directly from Instagram using the share button.
                </p>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                    We always download in the highest quality available. The quality depends on what the original uploader posted.
                </p>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                    If none of these solutions work, please use the contact form above with details about your issue. Include the URL you're trying to download.
                </p>
            </div>
        </div>
    </div>
...
(function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            // Show error message
            errorText.textContent = error.message || 'Please try again or email us directly at support@igreeldownloader.net';
