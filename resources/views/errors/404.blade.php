...
@section('content')
    ...
    <section class="relative py-20 sm:py-32 hero-gradient overflow-hidden min-h-[70vh] flex items-center">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-pink-500/10 rounded-full blur-3xl float-animation"
                style="animation-delay: 1s;"></div>
            <div
                class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-orange-500/5 rounded-full blur-3xl">
            </div>
        </div>
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="slide-up">
                <span
                    class="text-8xl sm:text-9xl lg:text-[12rem] font-black bg-gradient-to-r from-violet-600 via-pink-500 to-orange-400 bg-clip-text text-transparent leading-none">
                    404
                </span>
            </div>

            <!-- Error Message -->
            <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mt-4 mb-4 slide-up"
                style="animation-delay: 0.1s;">
                Page Not Found
            </h1>

            <p class="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-xl mx-auto slide-up"
                style="animation-delay: 0.2s;">
                Oops! The page you're looking for doesn't exist or has been moved. Don't worry, let's get you back on track.
            </p>

            <!-- Action Buttons -->
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 slide-up"
    ...
    <section class="py-12 bg-white dark:bg-gray-900">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Check URL -->
                <div
                    class="p-6 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 text-center">
                    <div
                        class="w-12 h-12 rounded-xl bg-violet-100 dark:bg-violet-900/30 flex items-center justify-center mx-auto mb-4">
                ...
                <div
                    class="p-6 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 text-center">
                    <div
                        class="w-12 h-12 rounded-xl bg-pink-100 dark:bg-pink-900/30 flex items-center justify-center mx-auto mb-4">
                ...
                <div
                    class="p-6 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 text-center">
                    <div
                        class="w-12 h-12 rounded-xl bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm">
                        <a href="{{ route('contact') }}" class="text-violet-600 dark:text-violet-400 hover:underline">Get in
                            touch</a> if you need assistance.
                    </p>
                </div>
            </div>
        </div>
