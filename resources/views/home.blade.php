...
<section class="relative py-16 sm:py-24 hero-gradient overflow-hidden">
    ...
    <div class="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <!-- Badge -->
        <div class="inline-flex items-center px-4 py-2 rounded-full bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300 text-sm font-medium mb-6 slide-up">
        ...
        <div class="flex flex-wrap justify-center gap-3 mt-8 slide-up" style="animation-delay: 0.5s">
            @foreach ($config['formats'] as $format)
                <span class="px-4 py-2 rounded-full bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 text-sm font-medium shadow-sm border border-gray-100 dark:border-gray-700">
                    {{ $format }}
                </span>
            @endforeach
        </div>
...
<section id="previewSection" class="hidden py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-200 dark:border-gray-800 overflow-hidden fade-in">
            <!-- Preview Header -->
            <div class="p-6 border-b border-gray-200 dark:border-gray-800">
                <div class="flex items-center space-x-4">
                    <div id="profilePic" class="w-14 h-14 rounded-full instagram-gradient flex items-center justify-center overflow-hidden">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                            <span id="contentType" class="px-2 py-0.5 rounded-md bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300 font-medium">Post</span>
                            <span>•</span>
            ...
            <div id="downloadAllContainer" class="hidden p-6 pt-0">
                <a href="#" id="downloadAllBtn" class="w-full py-4 rounded-xl instagram-gradient text-white font-semibold flex items-center justify-center space-x-2 hover:opacity-90 transition-opacity">
...
<section class="py-16 bg-white dark:bg-gray-900">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Reels Downloader -->
            @if(\App\Models\Page::where('slug', 'reels')->where('is_active', true)->exists())
            <a href="{{ route('instagram.reels') }}" class="feature-card p-6 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 group">
                <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm">Download Instagram Reels in HD quality without watermark.</p>
            </a>
            @endif

            <!-- Video Downloader -->
            @if(\App\Models\Page::where('slug', 'video')->where('is_active', true)->exists())
            <a href="{{ route('instagram.video') }}" class="feature-card p-6 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 group">
                <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-violet-500 to-purple-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm">Save IGTV and video posts in original HD quality.</p>
            </a>
            @endif

            <!-- Photo Downloader -->
            @if(\App\Models\Page::where('slug', 'photo')->where('is_active', true)->exists())
            <a href="{{ route('instagram.photo') }}" class="feature-card p-6 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 group">
                <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Story Downloader -->
            @if(\App\Models\Page::where('slug', 'story')->where('is_active', true)->exists())
            <a href="{{ route('instagram.story') }}" class="feature-card p-6 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 group">
                <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Carousel Downloader -->
            @if(\App\Models\Page::where('slug', 'carousel')->where('is_active', true)->exists())
            <a href="{{ route('instagram.carousel') }}" class="feature-card p-6 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 group">
                <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if(\App\Models\Page::where('slug', 'highlights')->where('is_active', true)->exists())
            <a href="{{ route('instagram.highlights') }}" class="feature-card p-6 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 group">
                <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-yellow-500 to-orange-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
                    </svg>
                </div>
                <h3 class="font-bold text-gray-900 dark:text-white text-lg mb-2">Highlights Downloader</h3>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600 dark:text-gray-400">Open Instagram and copy the link to the Reel, Video, Photo, or Story you want to download.</p>
            </div>

            <!-- Step 2 -->
            <div class="text-center">
                <div class="w-20 h-20 rounded-full instagram-gradient mx-auto flex items-center justify-center mb-6 pulse-glow" style="animation-delay: 0.5s">
                ...
                <p class="text-gray-600 dark:text-gray-400">Paste the URL in the input field above and click the Download button. We'll process it instantly.</p>
            </div>

            <!-- Step 3 -->
            <div class="text-center">
                <div class="w-20 h-20 rounded-full instagram-gradient mx-auto flex items-center justify-center mb-6 pulse-glow" style="animation-delay: 1s">
                ...
                <p class="text-gray-600 dark:text-gray-400">Click the download button to save the content to your device. It's that simple!</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="space-y-4">
            @foreach ($config['faqs'] as $faq)
                <div class="faq-item border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden">
                    <button class="faq-toggle w-full p-5 text-left flex items-center justify-between bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <span class="font-semibold text-gray-900 dark:text-white pr-4">{{ $faq['q'] }}</span>
                        <svg class="faq-icon w-5 h-5 text-gray-500 transition-transform flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
