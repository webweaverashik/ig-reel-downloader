            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @if (\App\Models\Page::where('slug', 'video')->where('is_active', true)->exists())
                    <a href="{{ route('instagram.video') }}"
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-sm">Save IGTV and video posts in original HD
                            quality.</p>
                    </a>
                @endif
                ...
                @if (\App\Models\Page::where('slug', 'photo')->where('is_active', true)->exists())
                    <a href="{{ route('instagram.photo') }}"
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-sm">Download Instagram photos in full resolution.
                        </p>
                    </a>
                @endif
                ...
                @if (\App\Models\Page::where('slug', 'story')->where('is_active', true)->exists())
                    <a href="{{ route('instagram.story') }}"
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-sm">Save stories anonymously before they disappear.
                        </p>
                    </a>
                @endif
                ...
                @if (\App\Models\Page::where('slug', 'carousel')->where('is_active', true)->exists())
                    <a href="{{ route('instagram.carousel') }}"
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-sm">Download all items from carousel posts at once.
                        </p>
                    </a>
                @endif
