...
$isActive = $item['is_active'] || ($isBlogLink && $isOnBlogPage);
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <button id="mobileMenuBtn"
                        class="md:hidden p-2 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
        ...
        <!-- Mobile Menu -->
        <div id="mobileMenu" class="fixed inset-0 md:hidden pointer-events-none" style="z-index: 9999;">
            <!-- Shadow Overlay -->
            <div id="mobileMenuOverlay"
                class="absolute inset-0 opacity-0 pointer-events-none transition-opacity duration-300 ease-in-out"
                style="background: linear-gradient(to right, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.5) 50%, rgba(0,0,0,0.3) 100%);">
            </div>

            <!-- Full Width Sidebar -->
            <div id="mobileMenuSidebar"
                class="absolute inset-0 w-full h-full flex flex-col transform -translate-x-full transition-transform duration-300 ease-out pointer-events-auto"
                ...
                <div class="p-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
                    ...
                    @else
                        <div class="flex items-center space-x-2">
                            ...
                            <span
                                class="font-bold text-gray-900 dark:text-white">{{ \App\Models\SiteSetting::get('site_name', 'IGReelDownloader') }}</span>
                        </div>
                    @endif
